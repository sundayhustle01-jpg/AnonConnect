...
const BeakerIcon = dynamic(() => import('lucide-react').then(mod => mod.BeakerIcon));
const UserPlus = dynamic(() => import('lucide-react').then(mod => mod.UserPlus));
const MessagesSquare = dynamic(() => import('lucide-react').then(mod => mod.MessagesSquare));
...
export default function LandingPage() {
            ...
            <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
              <div className="flex flex-col items-center text-center p-6 rounded-lg transition-transform hover:scale-105 hover:bg-secondary/50">
                ...
                <p className="text-muted-foreground">
                  No sign-ups, no profiles. Jump straight into a random chat with a random stranger from our global community.
                </p>
              </div>
              <div className="flex flex-col items-center text-center p-6 rounded-lg transition-transform hover:scale-105 hover:bg-secondary/50">
                <div className="p-4 bg-primary/10 rounded-full mb-4">
 ...
 Share
              ...
              <div className="flex justify-center gap-4 flex-wrap">
                ...
                <Button asChild variant="outline">
                  <a href={`https://www.facebook.com/sharer/sharer.php?u=${appUrl}`} target="_blank" rel="noopener noreferrer">
